...
class AccountController extends AbstractController
{
    ...
    {
        return $this->render('symfony-app/user/account/account.html.twig');
    }
    ...
    public function editAccount(User $user, Request $request, UserHandler $userHandler): Response
    {
        ...
        return $this->render('symfony-app/user/account/account-edit.html.twig', [
            'user' => $user,
    ...
    {
        return $this->render('symfony-app/user/account/data.html.twig');
    }
    ...
    public function downloadUserData(): Response
    {
        ...
        $html = $this->renderView('symfony-app/user/account/download-user-data.html.twig');
